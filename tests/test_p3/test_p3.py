...
class TestP3(unittest.TestCase):
    ...
    def test_apply_splits_edge_and_creates_hanging_node(self):
        ...
        self.assertNotIn(result['original_edge'], self.graph.edges)
        ...
        # midpoint coordinates should be average
        self.assertEqual(mid.x, (n1.x + n2.x) / 2)
        self.assertEqual(mid.y, (n1.y + n2.y) / 2)
